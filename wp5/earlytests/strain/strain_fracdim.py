...
t_start = 1264294887 # start GPS time
...
dec_fac_strain = 64 # decimate factor for fractal dim. calculation of the main strain
...
save_file = f'frac_dim_strain-{t_start}-{t_end}.hdf5' # path for save file
...
block_limit = 5000 # number of blocks per grid (equivelant to number of segments it computes in parallel)
...
if __name__ == '__main__':
    ...
    strain_data = gwpy.timeseries.TimeSeries.fetch_open_data(detector, t_start, t_end)
